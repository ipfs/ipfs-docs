---
title: 'Publish a file with IPFS using a pinning service in a CLI'
description: 'Learn how to publish content with IPFS by pinning a file to a pinning service using a CLI.'
---
