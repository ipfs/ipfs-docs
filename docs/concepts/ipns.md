...
1. Open a new command line/terminal window or tab and create the file that you want to set up with IPNS. For the tutorial, we're just going to create a simple _hello world_ file:
...
1. Publish your `Qm` hash to IPNS:
   ...
   `k51...` is the name or [hash](hashing.md) of the public key for the IPFS you have running. You can now change the file repeatedly and, even though the CID changes when you change the file, you can continue to access it with this key.
