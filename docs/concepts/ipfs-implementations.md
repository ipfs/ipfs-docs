...
| [IPFS Companion](https://github.com/ipfs/ipfs-companion) | javascript  | Browser extension adding support for `ipfs://` addresses which are fetched by a local Kubo node        |
...
| [Boxo](https://github.com/ipfs/boxo)        | go          | A component library for building narrower IPFS applications and implementations.                 |
| [Helia](https://github.com/ipfs/helia)      | typescript  | A lean, modular, and modern implementation of IPFS for the prolific JS and browser environments. |
| [Iroh](https://github.com/n0-computer/iroh) | rust        | Extremely efficiency-oriented IPFS implementation (bespoke distribution, no UnixFS).             |
...
| [inbrowser.link](https://github.com/ipfs/service-worker-gateway) | typescript  | IPFS Gateway implemented in a Service Worker, built with Helia and Verified Fetch            |
...
| [Someguy](https://github.com/ipfs/someguy/)                      | go          | A Delegated Routing V1 server and client for finding CIDs across all corners of the network. |
...
| [Curio](https://github.com/filecoin-project/curio)    | go          | Newer Filecoin node with similar goals to Lotus with auto-scaling and easier maintenace.   |
