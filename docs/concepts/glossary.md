...
A lean, modular, and modern implementation of IPFS for the prolific JS and browser environments. Supereded [js-ipfs](#js-ipfs). Learn more at [https://github.com/ipfs/helia](https://github.com/ipfs/helia).
