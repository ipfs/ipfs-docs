...
- **See how to work with peers** using methods like [customizing libp2p bundles](https://github.com/ipfs/js-ipfs/blob/master/packages/ipfs/examples/custom-libp2p) and [using circuit relay](https://github.com/ipfs/js-ipfs/blob/master/packages/ipfs/examples/circuit-relaying)
- **Understand website hosting** by starting with how to [host a simple single-page site](/how-to/host-single-page-site/)
- **Work with blockchains** like the [Ethereum](https://github.com/ipfs/js-ipfs/blob/master/packages/ipfs/examples/explore-ethereum-blockchain) chain
...
- **Understand how IPFS works in the browser** by learning how to [address IPFS on the Web](/how-to/address-ipfs-on-web/), seeing how to [exchange files between nodes](https://github.com/ipfs/js-ipfs/blob/master/packages/ipfs/examples/exchange-files-in-browser), seeing [how IPFS can be used in your favorite browser tools and frameworks](/how-to/browser-tools-frameworks/), and more
