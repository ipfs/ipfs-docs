...
This document is autogenerated from [cli.sh](https://github.com/ipfs-inactive/docs/blob/master/scripts/cli.sh). For issues and support, check out the [docs repository](https://github.com/ipfs/ipfs-docs) on GitHub.
