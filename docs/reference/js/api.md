...
:::warning js-ipfs has been discontinued
[js-ipfs](https://github.com/ipfs/js-ipfs) was a legacy JavaScript IPFS implementation that has been superseded by [Helia](https://github.com/ipfs/helia). New projects should use Helia.
:::
