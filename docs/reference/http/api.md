...
::: tip
This document was autogenerated from go-ipfs. For issues and support, check
...
This happens as follows: Every part in the multipart request is a _directory_
or a _file_ to be added to IPFS.
