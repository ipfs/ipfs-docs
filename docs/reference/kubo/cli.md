...
::: tip Generated on 2024-01-12 17:36:37, from kubo 0.25.0
This document was autogenerated from CLI help text in [kubo 0.25.0](https://github.com/ipfs/kubo/releases/tag/v0.25.0)
...
USAGE
  ipfs dns <domain-name> - Resolve DNSLink records. Deprecated: Use 'ipfs
                           resolve /ipns/domain-name' instead.
