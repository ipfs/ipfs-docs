...
::: tip Generated on 2023-05-09, from kubo v0.20.0
This document was autogenerated from [v0.20.0](https://github.com/ipfs/kubo/releases/tag/v0.20.0).
...
`curl -X POST -F file=@myfile "http://127.0.0.1:5001/api/v0/name/inspect?verify=<value>"`
...
`curl -X POST -F file=@myfile "http://127.0.0.1:5001/api/v0/routing/put?arg=<key>"`
...
`curl -X POST -F file=@myfile "http://127.0.0.1:5001/api/v0/dht/put?arg=<key>"`
