...
::: tip Generated on 2026-04-24, from kubo v0.41.0
This document was autogenerated from [v0.41.0](https://github.com/ipfs/kubo/releases/tag/v0.41.0).
...
`curl -X POST -F file=@myfile "http://127.0.0.1:5001/api/v0/dag/import?pin-roots=true&silent=<value>&stats=<value>&fast-provide-root=<value>&fast-provide-dag=<value>&fast-provide-wait=<value>&allow-big-block=false"`
...
Trigger reprovider (legacy provider only).
