...
![Screenshot of some Markdown in VSCode showing an error.](images/style-and-formatting/no-empty-links-error.png)

The extension summarizes all the warnings within the open file at the bottom of the editor:

![Screenshow of VSCode with a summary of markdown errors.](images/style-and-formatting/markdown-error-summary.png)
