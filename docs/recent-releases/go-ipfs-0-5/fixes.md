...
You can find a complete list of the bugs squashed this release below or [over on GitHub →](https://github.com/ipfs/go-ipfs/blob/master/CHANGELOG.md)
...
- github.com/ipfs/go-log (v0.0.1 -> v1.0.4):
  - add IPFS\_\* env vars back for transitionary release of go-log ([ipfs/go-log#67](https://github.com/ipfs/go-log/pull/67))
