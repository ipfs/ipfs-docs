...
1. Download the [`docker-compose.yml` file](https://raw.githubusercontent.com/ipfs/ipfs-cluster/v1.1.6/docker-compose.yml) and place it into the `ipfs-cluster-ctl` directory:
