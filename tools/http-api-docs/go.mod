...
require (
	...
	github.com/ipfs/go-ds-pebble v0.5.13 // indirect
...
// TODO: drop once kubo no longer replaces go-libp2p in its own go.mod.
// Kubo v0.43.1 pins this fork; Go ignores replace directives of dependencies.
